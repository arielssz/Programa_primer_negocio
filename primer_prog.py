...
def sumar_factura(factura, valor):
    factura = factura + valor
    return factura

def agregar_a_factura(lista_productos, orden, valor):
    lista_productos = lista_productos + " - " + orden + " ($" + str(valor) + ")"
...
while salir == 0:
    ...
    if orden != "":
        ...
        lista_productos = agregar_a_factura(lista_productos, orden, valor)
        print("------------------------------------------------------")
